...
- Generated: 2026-06-12 21:44:20.249 UTC
...
- Result: PASS - Static report guarded session complete: writes=3, reports=4, pollReads=55.
...
- Diagnostics: diagnostics=PASS_WITH_WARNING, reports=4, values=6, mappedFailures=0, partialMappings=0, pollReads=55/55, writeFailures=0, seqGaps=0, seqRegressions=1, entryIdGaps=2, entryIdRegressions=0, duplicates=0, bufOvfl=true
- Diagnostic status: PASS_WITH_WARNING
- EntryID: 000000000000000D -> 0000000000000013
...
- 1 sequence regression/reset(s) were observed per report stream.
