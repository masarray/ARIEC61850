...
/// Mature IEC 61850 clients may explicitly reserve a BRCB when ResvTms is exposed,
/// while retaining implicit RptEna ownership as a compatible fallback. GI is issued
/// only after the persistent receiver/session exists.
/// </summary>
